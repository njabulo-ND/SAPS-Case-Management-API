...
def fill_all_forms(p21_form, case_number):
    try:
        ...
        combined_schema = {
            ...
            "required": ["investigationDiary", "modusOperandi", "statement"],
        }
        ...
        save_json_data({"Filled all forms": "Done"})
        return filled_data
            ...
            try:
                ...
                if data.get('p21'):
                    ...
                    query = """
                                ...
                                VALUES
                                (:p21,:victim,:email_of_the_victim,'UNASSIGNED');
                        """
                    with engine.connect() as conn:
                        result = conn.execute(
                            text(query), {'p21': p21_form, 'victim': victim, 'email_of_the_victim': email_of_the_victim})
